...
export function DividerClose(){
    return(
        <div className=' relative overflow-hidden h-[70px] bg-anaranjado'>
            <div className='absolute w-full top-[2px] bg-black opacity-10 clip-close h-[250px]'></div>
...
export function DividerOpen2() {
  return (
    <div className=' relative overflow-hidden h-[70px] bg-anaranjado'>
        <div className='absolute w-full top-[9px] bg-black opacity-10 clip-open-2 h-[250px]'></div>
...
export function DividerClose2(){
  return(
      <div className=' relative overflow-hidden h-[70px] bg-anaranjado'>
          <div className='absolute w-full top-[6px] bg-black opacity-10 clip-close-2 h-[250px]'></div>
